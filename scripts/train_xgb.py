#!/usr/bin/env python
"""Train XGBoost on full dataset only."""
...
out = [{"model": "XGBoost", "metrics": results, "train_time": round(rt, 1),
        "infer_ms": round(it, 4), "params": {"n_estimators": 200, "max_depth": 6, "learning_rate": 0.1},
        "subset": "full"}]
with open("data/processed/xgb_results.json", "w") as f:
    json.dump(out, f, indent=2)
print("Saved to data/processed/xgb_results.json")
