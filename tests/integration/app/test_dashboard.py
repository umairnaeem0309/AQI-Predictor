...
class TestDashboard:
    ...
    def test_prediction_response_structure(self):
        ...
        required_fields = [
            "city", "timestamp", "aqi_24h", "aqi_48h", "aqi_72h",
    ...
    def test_health_response_structure(self):
        ...
        required_fields = [
            "status", "model_loaded", "feature_store_connected",
            "last_prediction", "version",
        ]
    ...
    def test_model_info_response_structure(self):
        ...
        required_fields = [
            "model_name", "model_version", "status", "approval_status",
            "training_date", "dataset_type", "feature_version", "metrics",
        ]
